...
#'
#' The description of the dataset was copied from the \code{DALEX} package.
#'
...
#' @name titanic_data
#' @references   \url{https://www.encyclopedia-titanica.org},
...
#' \url{https://www.encyclopedia-titanica.org} on April 5, 2016.
